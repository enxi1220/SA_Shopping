...
VALUES
    ('PD12345', 1, 'M', 'Available', 'Red', 'Cotton', 10, 50, '2023-09-01 06:00:00', '2023-09-01 06:00:00', 'Admin'),
...
INSERT INTO `order` (order_no, product_detail_id, product_detail_no, buyer_id, status, product_name, price, quantity, size, color, material, delivery_address, delivery_fee, total_price, created_date)
VALUES
    ('ORDER123', 1, 'PD12345', 1, 'Closed', 'Product One', 50.00, 2, 'M', 'Red', 'Cotton', '123 Buyer St', 5.00, 105.00, '2023-09-01 11:00:00'),
    ('ORDER234', 3, 'PD13345', 2, 'Delivered', 'Product Two', 60.00, 3, 'S', 'Red', 'Cotton', '456 Buyer St', 5.00, 185.00, '2023-09-01 12:00:00'),
    ('ORDER345', 3, 'PD23456', 3, 'Shipped', 'Product Three', 70.00, 1, 'S', 'Green', 'Silk', '789 Buyer St', 5.00, 75.00, '2023-09-01 13:00:00'),
    ('ORDER456', 4, 'PD22456', 4, 'Confirmed', 'Product Four', 80.00, 2, 'XL', 'Black', 'Wool', '123 Buyer St', 5.00, 170.00, '2023-09-01 14:00:00'),
    ('ORDER567', 5, 'PD34567', 5, 'Received', 'Product Five', 90.00, 2, 'M', 'White', 'Cotton', '456 Buyer St', 5.00, 190.00, '2023-09-01 15:00:00'),
    ('ORDER133', 2, 'PD13345', 1, 'Closed', 'Product One', 50, 2, 'S', 'Red', 'Cotton', '123 Buyer St', 5, 105, '2023-09-01 11:00:00');
...
VALUES
    ...
    ('PAY133', 6, 190.00, '2023-09-01 20:00:00', 'Apple Pay');

INSERT INTO review (product_id, order_id, buyer_email, review_text, status, sentiment, created_date, updated_date)
VALUES
    (1, 1, 'buyer1@example.com', 'This is a good product!', 'Posted', 0, '2023-09-01 21:00:00', '2023-09-01 21:00:00'),
    (1, 2, 'buyer2@example.com', 'Product quality is excellent.', 'Posted', 0.9, '2023-09-01 22:00:00', '2023-09-01 22:00:00'),
    (3, 3, 'buyer3@example.com', 'Fast delivery and good packaging.', 'Posted', 0.85, '2023-09-01 23:00:00', '2023-09-01 23:00:00'),
    (4, 4, 'buyer4@example.com', 'Satisfied with the purchase.', 'Posted', 0.75, '2023-09-02 00:00:00', '2023-09-02 00:00:00'),
    (5, 5, 'buyer5@example.com', 'Product arrived as described.', 'Posted', 0.9, '2023-09-02 01:00:00', '2023-09-02 01:00:00'),
    (1, 6, 'buyer1@example.com', 'This is a shit product!', 'Updated', -1, '2023-09-01 21:00:00', '2023-09-12 21:00:00');
