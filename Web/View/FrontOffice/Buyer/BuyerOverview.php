    ...
    <div class="row d-flex justify-content-center h-100 mt-5">
        <div class="col-3 card h-100 ">
            ...
            <div class="nav flex-column nav-tabs rounded" id="nav-tabs" role="tablist" aria-orientation="vertical">
                <a class="nav-link active ripple rounded-top" id="buyer-view-nav-tab" data-mdb-ripple-color="info" data-mdb-toggle="tab" role="tab" aria-controls="buyer-view" aria-selected="false" href="#buyer-view"><i class="fas fa-user pe-3"></i>Profile Overview</a>
